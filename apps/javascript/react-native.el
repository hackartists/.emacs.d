...
(defun hackartist/javascript/dap-react-native-init ()
  (require 'dap-mode)
  (require 'dap-utils)
  ...
  (defcustom dap-react-native-debug-program `("node"
                                              ,(f-join dap-react-native-debug-path "extension/src/debugger/direct/reactNativeDirectDebugEntryPoint.js"))
  ...
  (dap-register-debug-template "React Native iOS"
                               (list :type "react-native"
                                     :cwd nil
                                     :request "launch"
                                     :platform "ios"
                                     :name "React Native iOS"))
  (dap-register-debug-template "React Native Android"
                               (list :type "react-native"
                                     :cwd nil
                                     :request "launch"
                                     :platform "android"
