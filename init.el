...
;;    (quote
;;     (exwm dashboard dashboard-hackernews dashboard-project-status date-field ido-grid-mode idomenu inf-mongo mongo reveal-in-osx-finder minibuffer-complete-cycle go-snippets go-imports go-imenu go-dlv go-add-tags go-playground yasnippet-snippets pylookup))))
;; (custom-set-faces
